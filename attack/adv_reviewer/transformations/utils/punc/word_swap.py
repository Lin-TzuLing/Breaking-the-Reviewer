        ...
        for i in indices_to_modify:
            ...
            for r in replacement_words:
                ...
                if "modified_index" in modified_text.attack_attrs:
                    modified_text.attack_attrs["modified_index"].append(
                        list(indices_to_modify)[0]
                    )
                    if "modified_index" in current_text.attack_attrs:
                        modified_text.attack_attrs["modified_index"].extend(
                            current_text.attack_attrs["modified_index"]
                        )
                else:
                    modified_text.attack_attrs["modified_index"] = [
                        list(indices_to_modify)[0]
                    ]
                    if "modified_index" in current_text.attack_attrs:
                        modified_text.attack_attrs["modified_index"].extend(
