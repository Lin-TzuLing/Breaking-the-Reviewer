...
class GPT4o(OpenAIModelWrapper):
    """
    GPT-4o model wrapper for paper review generation.
    This class provides a wrapper around the OpenAI GPT-4o model, specifically configured
    ...
    Example:
        >>> gpt4o = GPT4o("gpt-4o-mini", openai_key="your-api-key")
        >>> result = gpt4o("Evaluate the novelty of this paper...")
        >>> print(result)
    """
    ...
    def __init__(self, model_name, **kwargs):
        ...
        super().__init__(model_name, max_new_tokens, model_temperature, system_prompt, openai_key)   
